...
![](`r here::here("Week 8 Xenium Annotation", "Images", "Week_8", "schedule.png")`)
...
![](`r here::here("Week 8 Xenium Annotation", "Images", "Week_8", "10x_xenium.png")`)

#### See SCORE #6 for **Background** on Spatial Transcriptomics

https://usckrc.github.io/website/SCORE_6__LZ_ST_ppt.pdf

#### See SCORE #7 for **Starting with a Xenium Dataset**
...
### How do you **annotate** this object? What would you want to know **beforehand**?

### Insight from snRNAseq analysis from **similar tissue**

#### I'm **still suprised** at how similar this looks to a dissociated snRNAseq dataset

### I started with what I knew about dissociated snRNaseq from this tissue

#### Both from the literature and my own experience and background knowledge about the kidney

### I applied my snRNaseq guide markers

https://usckrc.github.io/website/scRNAseq_guide.html

![](`r here::here("Week 8 Xenium Annotation", "Images", "Week_8", "markers.png")`)
...
![](`r here::here("Week 8 Xenium Annotation", "Images", "Week_8", "annotation_v1b.png")`)

## **Spatial Informed** Annotation

### Is there **additional** information that we could get from the Xenium dataset?

### Lessons from **Endothelial Cells**
...
#### **Clear** Spatial Distribution of EC Populations (**That Make Sense**)
...
#### Were these the **best markers** that I could be using for annotation?
...
#### Did **FindAllMarkers** and Analyzed the Top Markers for each cluster
...
### Currently work on creating a different **annotation guide** for **Xenium**
### Need to go back to a snRNAseq dataset and see how well **Spatial Gene Marker List** works
...
#### **Spatial Cell Segmentation Algorithms**
